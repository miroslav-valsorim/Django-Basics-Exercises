...
from user_register_login_logout.shopping_cart.views import add_to_cart, remove_from_cart, ShoppingCartSummary, \
    remove_single_item_from_cart, add_single_item_to_cart
